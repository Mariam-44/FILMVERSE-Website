...
export default function Genres() {
  ...
  if (!genre || !genre.id) return <p className="text-white">No genre selected.</p>;

  return (
    <div className="container mx-auto px-4 my-12">
       <div className="text-center">
          <h1 className="text-3xl md:text-5xl pt-16 font-bold text-white mb-4">
            All <span className="bg-gradient-to-r from-red-400 to-red-600 bg-clip-text text-transparent">{title}</span>
          </h1>
        </div>
